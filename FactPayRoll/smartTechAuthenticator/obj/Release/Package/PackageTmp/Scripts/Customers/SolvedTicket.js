$(document).ready(function () {
    var tbl_Customer = $("#tbl_Solved_Tickets").DataTable({
        ...
        "ajax": {
            "url": "/TicketSystem/SolvedTickets",
            "type": "POST",
            "datatype": "json"
        },
        'columnDefs': [{
        ...
        "columns": [
            ...
            },
            {
                data: null, render: function (data, type, row) {
                    ...
                    return "<button type='button' class='btn btn-success'>" + row.Status + "</button>";
                }
            },
            {
                data: null, render: function (data, type, row) {
    ...
    $('.lblStatus').on('change', function () {
        ...
        $("#tbl_Solved_Tickets").DataTable({
            ...
            "ajax": {
                "type": "POST",
                "url": "/TicketSystem/FilterSolvedTickets",
                "datatype": "json",
                'data': newdata
            }, 'columnDefs': [{
                'targets': [0, 1,6, 7, 8,], // column index (start from 0)

...
$(document).ready(function () {
        ...
        "columns": [
            ...
            { "data": "UserPass", "name": "UserPass", "autoWidth": true },
            {
                data: null, render: function (data, type, row) {
                    return "<a href='/Accountant/AccountantDetails?Id=" + row.Id + "' class='btn btn-info' >Edit</a>";
                }
            },
            {
                data: null, render: function (data, type, row) {
            ...
            {
                data: null, render: function (data, type, row) {
                    return "<a href='ViewAccountant?Id=" + row.Id + "' class='btn btn-info' >View</a>";
                }
            },
    ...
    $(document).on("click", ".btn-delete", function () {
        if (confirm("Are you sure, you want to delete?")) {
            ...
            $.ajax({
                type: "POST",
                url: "/Accountant/DeleteAccountant",
                data: Category,
                success: function (response) {
                    if (response.Status == 1) {
                        ...
                        showMessage("Failed", "Accountant not deleted successfully,Please delete all references.",);
                    }
                },
                error: function () {
                    showMessage("Failed", "Accountant not deleted successfully",);
                }
            });
        }
    });
